...
//*********************************************************************/
    ...
    public static double calcJD(Calendar date)
    {
        return calcJD(date.get(Calendar.YEAR), date.get(Calendar.MONTH), date.get(Calendar.DAY_OF_MONTH));
    }
    ...
    public static String getTimeString(double time, int timezone, double JD, boolean dst)
    {
        double timeLocal = time + (timezone * 60.0);
        double riseT = calcTimeJulianCent(JD + time / 1440.0);
        timeLocal += ((dst) ? 60.0 : 0.0);
        return getTimeString(timeLocal);
    }

    public static Calendar getDateTime(double time, int timezone, Calendar date, boolean dst)
    {
    ...
    public static String getTimeString(boolean min, double time, int timezone, double JD, boolean dst)
    {
        double timeLocal = time + (timezone * 60.0);
    ...
    private static Calendar getDateTime(double minutes, Calendar date)
    {
        ...
        if ((minutes >= 0) && (minutes < 1440))
        {
            ...
            return new GregorianCalendar(date.get(Calendar.YEAR), date.get(Calendar.MONTH), date.get(Calendar.DAY_OF_MONTH), (int)hour, (int)minute, (int)second);
        }
        else
        {
            return retVal;
